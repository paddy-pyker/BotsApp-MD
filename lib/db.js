var data = {
    general: {
        ...
        BOT_NOT_ADMIN: "```Sorry, I don't have permission to do so since I am not an admin. Make me an admin and try again 😃️```",
        ADMIN_PERMISSION: "```You need to be an admin to execute this command.```",
        SUDO_PERMISSION: "```Hey there, I am a BOT in ``` *{BotsApp.groupName}*``` which allows only the owner and sudo users to use the command``` *{commandName}* ```.",
    ...
    mute: {
        ...
        NOT_ADMIN: "```Sorry, I don't have permission to do so since I am not an admin. Make me an admin and try again 😃️```",
    ...
    tagall: {
        DESCRIPTION: "Module to tag everyone",
        ...
        TAG_MESSAGE: "*Attention Everyone 📢️*"
    },
    ud: {
